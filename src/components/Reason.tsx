    ...
    <div className='w-full'>
      <div className='mx-auto max-w-[1284px] px-5 py-[18px] sm:px-8 sm:py-[100px]'>
        <div className='mx-auto mb-[60px] flex max-w-[876px] flex-col justify-center gap-3 text-center sm:gap-6'>
          <h2 className='text-header-mobile-1 text-app-neutral-900 lg:text-header-desktop-1'>
            Why must choose us
          </h2>
          <p className='font-urbanist text-body-tablet-16 font-medium text-app-neutral-600 lg:text-body-desktop-18'>
        ...
        <div className='grid grid-cols-1 items-center justify-between gap-4 sm:grid-cols-3 sm:gap-[28px]'>
          {reasons.map((data, index) => (
            <div
              key={index}
              className='group flex h-full flex-col border-t-4 border-t-app-brand-600 px-5 pb-[32px] pt-[28px] duration-500 ease-in-out hover:bg-app-brand-600'
            >
